...
// 1. Arrays will print as string seperated with commas by default
answersPTag.innerHTML += studentGrades;

// 2. Access specific values in array using indeses
//studentGrades{0}; indeses start at 0
...
// 3. Remove the first item to an array
friends.splice(0, 1);
printFriends();

// 4. Add item to front of array using the splice method
...
// 3. Printing object varible use the JSON.stringify metho
